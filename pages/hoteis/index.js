        ...
        <div id="page-wrap">
            ...
            <div id="container">
              ...
              <div className="box">
                ...
                <div className="texto">
                  ...
                  (170) avaliações
                  <br />
                  Convenientemente situado no bairro de Amaralina, em Salvador,
                  o Rede Andrade Riviera Premium está localizado a 2,7 km da
                  Praia Pituba, a 5 km do Shopping Iguatemi e a 6 km da Estação
                  Rodoviária.
                </div>
              </div>
              <div class="box">
                ...
                <div class="texto">
                  ...
                  (170) avaliações
                  <br />
                  Situado bem em frente à Praia da Barra, o hotel 4 estrelas
                  Rede Andrade Barra tem uma localização central e oferece vista
                  do mar da Baía de Todos os Santos, no bairro da Barra, em
                  Salvador...
                </div>
              </div>
              <div class="box">
                ...
                <div class="texto">
                  ...
                  com banheira de hidromassagem e vista do mar.beach and few
                  bars around...
                </div>
              </div>
            </div>
          ...
          <div className="footer">
            <div class="publicidade">
              {" "}
              <a href="#">
                <img src="/html/img/publicidade.jpg" width="100%" height="57" />
              </a>{" "}
            </div>
          </div>
        </div>
